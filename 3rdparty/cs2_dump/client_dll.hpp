...
// 2024-10-18 00:22:42.153529400 UTC
    ...
    namespace schemas {
        ...
        namespace client_dll {
            ...
            namespace C_BaseCSGrenade {
                constexpr std::ptrdiff_t m_bClientPredictDelete = 0x1B10; // 
                constexpr std::ptrdiff_t m_bRedraw = 0x1B11; // 
                constexpr std::ptrdiff_t m_bIsHeldByPlayer = 0x1B12; // 
                constexpr std::ptrdiff_t m_bPinPulled = 0x1B13; // 
                constexpr std::ptrdiff_t m_bJumpThrow = 0x1B14; // 
                constexpr std::ptrdiff_t m_bThrowAnimating = 0x1B15; // 
                constexpr std::ptrdiff_t m_fThrowTime = 0x1B18; // 
                constexpr std::ptrdiff_t m_flThrowStrength = 0x1B1C; // 
                constexpr std::ptrdiff_t m_flThrowStrengthApproach = 0x1B20; // 
                constexpr std::ptrdiff_t m_fDropTime = 0x1B24; // 
                constexpr std::ptrdiff_t m_fPinPullTime = 0x1B28; // 
                constexpr std::ptrdiff_t m_bJustPulledPin = 0x1B2C; // 
                constexpr std::ptrdiff_t m_nNextHoldTick = 0x1B30; // 
                constexpr std::ptrdiff_t m_flNextHoldFrac = 0x1B34; // 
                constexpr std::ptrdiff_t m_hSwitchToWeaponAfterThrow = 0x1B38; // 
            }
            // Parent: C_FuncBrush
            // Field count: 8
            //
            ...
            namespace C_SmokeGrenadeProjectile {
                ...
                constexpr std::ptrdiff_t m_bSmokeVolumeDataReceived = 0x1250; // 
                constexpr std::ptrdiff_t m_bSmokeEffectSpawned = 0x1251; // 
            }
            // Parent: C_SoundEventEntity
            // Field count: 0
            ...
            namespace C_CSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_iRetakesOffering = 0x1710; // 
                constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0x1714; // 
                constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0x1718; // 
                constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0x1719; // 
                constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0x171C; // 
                constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x1720; // 
                constexpr std::ptrdiff_t m_bNeedToReApplyGloves = 0x1740; // 
                constexpr std::ptrdiff_t m_EconGloves = 0x1748; // 
                constexpr std::ptrdiff_t m_nEconGlovesChanged = 0x1B90; // 
                constexpr std::ptrdiff_t m_bMustSyncRagdollState = 0x1B91; // 
                constexpr std::ptrdiff_t m_nRagdollDamageBone = 0x1B94; // 
                constexpr std::ptrdiff_t m_vRagdollDamageForce = 0x1B98; // 
                constexpr std::ptrdiff_t m_vRagdollDamagePosition = 0x1BA4; // 
                constexpr std::ptrdiff_t m_szRagdollDamageWeaponName = 0x1BB0; // 
                constexpr std::ptrdiff_t m_bRagdollDamageHeadshot = 0x1BF0; // 
                constexpr std::ptrdiff_t m_vRagdollServerOrigin = 0x1BF4; // 
                constexpr std::ptrdiff_t m_bLastHeadBoneTransformIsValid = 0x2278; // 
                constexpr std::ptrdiff_t m_lastLandTime = 0x227C; // 
                constexpr std::ptrdiff_t m_bOnGroundLastTick = 0x2280; // 
                constexpr std::ptrdiff_t m_qDeathEyeAngles = 0x229C; // 
                constexpr std::ptrdiff_t m_bSkipOneHeadConstraintUpdate = 0x22A8; // 
                constexpr std::ptrdiff_t m_bLeftHanded = 0x22A9; // 
                constexpr std::ptrdiff_t m_fSwitchedHandednessTime = 0x22AC; // 
                constexpr std::ptrdiff_t m_flViewmodelOffsetX = 0x22B0; // 
                constexpr std::ptrdiff_t m_flViewmodelOffsetY = 0x22B4; // 
                constexpr std::ptrdiff_t m_flViewmodelOffsetZ = 0x22B8; // 
                constexpr std::ptrdiff_t m_flViewmodelFOV = 0x22BC; // 
                constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x22C0; // 
                constexpr std::ptrdiff_t m_GunGameImmunityColor = 0x22F8; // 
                constexpr std::ptrdiff_t m_vecBulletHitModels = 0x2348; // 
                constexpr std::ptrdiff_t m_bIsWalking = 0x2360; // 
                constexpr std::ptrdiff_t m_thirdPersonHeading = 0x2368; // 
                constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x2380; // 
                constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x2390; // 
                constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x23A0; // 
                constexpr std::ptrdiff_t m_entitySpottedState = 0x23B8; // 
                constexpr std::ptrdiff_t m_bIsScoped = 0x23D0; // 
                constexpr std::ptrdiff_t m_bResumeZoom = 0x23D1; // 
                constexpr std::ptrdiff_t m_bIsDefusing = 0x23D2; // 
                constexpr std::ptrdiff_t m_bIsGrabbingHostage = 0x23D3; // 
                constexpr std::ptrdiff_t m_iBlockingUseActionInProgress = 0x23D4; // 
                constexpr std::ptrdiff_t m_flEmitSoundTime = 0x23D8; // 
                constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x23DC; // 
                constexpr std::ptrdiff_t m_nWhichBombZone = 0x23E0; // 
                constexpr std::ptrdiff_t m_iShotsFired = 0x23E4; // 
                constexpr std::ptrdiff_t m_flFlinchStack = 0x23E8; // 
                constexpr std::ptrdiff_t m_flVelocityModifier = 0x23EC; // 
                constexpr std::ptrdiff_t m_flHitHeading = 0x23F0; // 
                constexpr std::ptrdiff_t m_nHitBodyPart = 0x23F4; // 
                constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x23F8; // 
                constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x23FC; // 
                constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x2401; // 
                constexpr std::ptrdiff_t m_ArmorValue = 0x2404; // 
                constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x2408; // 
                constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x240A; // 
                constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x240C; // 
                constexpr std::ptrdiff_t m_nLastKillerIndex = 0x2410; // 
                constexpr std::ptrdiff_t m_bOldIsScoped = 0x2414; // 
                constexpr std::ptrdiff_t m_bHasDeathInfo = 0x2415; // 
                constexpr std::ptrdiff_t m_flDeathInfoTime = 0x2418; // 
                constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x241C; // 
                constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x2428; // 
                constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x242C; // 
                constexpr std::ptrdiff_t m_angStashedShootAngles = 0x2430; // 
                constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x243C; // 
                constexpr std::ptrdiff_t m_vecStashedVelocity = 0x2448; // 
                constexpr std::ptrdiff_t m_angShootAngleHistory = 0x2454; // 
                constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x246C; // 
                constexpr std::ptrdiff_t m_vecVelocityHistory = 0x2484; // 
                constexpr std::ptrdiff_t m_PredictedDamageTags = 0x24A0; // 
                constexpr std::ptrdiff_t m_nPrevHighestReceivedDamageTagTick = 0x24F0; // 
                constexpr std::ptrdiff_t m_nHighestAppliedDamageTagTick = 0x24F4; // 
            }
            ...
            namespace C_WeaponBaseItem {
                constexpr std::ptrdiff_t m_SequenceCompleteTimer = 0x1B10; // 
                constexpr std::ptrdiff_t m_bRedraw = 0x1B28; // 
            }
            // Parent: None
            // Field count: 21
            //
            ...
            namespace C_CSWeaponBaseGun {
                constexpr std::ptrdiff_t m_zoomLevel = 0x1B10; // 
                constexpr std::ptrdiff_t m_iBurstShotsRemaining = 0x1B14; // 
                constexpr std::ptrdiff_t m_iSilencerBodygroup = 0x1B18; // 
                constexpr std::ptrdiff_t m_silencedModelIndex = 0x1B28; // 
                constexpr std::ptrdiff_t m_inPrecache = 0x1B2C; // 
                constexpr std::ptrdiff_t m_bNeedsBoltAction = 0x1B2D; // 
            }
            // Parent: C_BaseEntity
            // Field count: 4
            //
            ...
            namespace C_CSGO_PreviewPlayer {
                constexpr std::ptrdiff_t m_animgraph = 0x3A30; // 
                constexpr std::ptrdiff_t m_animgraphCharacterModeString = 0x3A38; // 
                constexpr std::ptrdiff_t m_flInitialModelScale = 0x3A40; // 
            }
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            namespace C_C4 {
                constexpr std::ptrdiff_t m_szScreenText = 0x1B10; // 
                constexpr std::ptrdiff_t m_activeLightParticleIndex = 0x1B30; // 
                constexpr std::ptrdiff_t m_eActiveLightEffect = 0x1B34; // 
                constexpr std::ptrdiff_t m_bStartedArming = 0x1B38; // 
                constexpr std::ptrdiff_t m_fArmedTime = 0x1B3C; // 
                constexpr std::ptrdiff_t m_bBombPlacedAnimation = 0x1B40; // 
                constexpr std::ptrdiff_t m_bIsPlantingViaUse = 0x1B41; // 
                constexpr std::ptrdiff_t m_entitySpottedState = 0x1B48; // 
                constexpr std::ptrdiff_t m_nSpotRules = 0x1B60; // 
                constexpr std::ptrdiff_t m_bPlayedArmingBeeps = 0x1B64; // 
                constexpr std::ptrdiff_t m_bBombPlanted = 0x1B6B; // 
            }
            // Parent: C_BaseModelEntity
            // Field count: 13
            //
            ...
            namespace C_WeaponShield {
                constexpr std::ptrdiff_t m_flDisplayHealth = 0x1B30; // 
            }
            // Parent: C_PointClientUIWorldPanel
            // Field count: 1
            //
            ...
            namespace C_WeaponTaser {
                constexpr std::ptrdiff_t m_fFireTime = 0x1B30; // 
                constexpr std::ptrdiff_t m_nLastAttackTick = 0x1B34; // 
            }
            // Parent: C_CSWeaponBase
            // Field count: 2
            //
            ...
            namespace C_Fists {
                constexpr std::ptrdiff_t m_bPlayingUninterruptableAct = 0x1B10; // 
                constexpr std::ptrdiff_t m_nUninterruptableActivity = 0x1B14; // 
            }
            ...
            namespace C_CSWeaponBase {
                ...
                constexpr std::ptrdiff_t m_hPrevOwner = 0x18C0; // 
                constexpr std::ptrdiff_t m_nDropTick = 0x18C4; // 
                constexpr std::ptrdiff_t m_donated = 0x18E4; // 
                constexpr std::ptrdiff_t m_fLastShotTime = 0x18E8; // 
                constexpr std::ptrdiff_t m_bWasOwnedByCT = 0x18EC; // 
                constexpr std::ptrdiff_t m_bWasOwnedByTerrorist = 0x18ED; // 
                constexpr std::ptrdiff_t m_gunHeat = 0x18F0; // 
                constexpr std::ptrdiff_t m_smokeAttachments = 0x18F4; // 
                constexpr std::ptrdiff_t m_lastSmokeTime = 0x18F8; // 
                constexpr std::ptrdiff_t m_flNextClientFireBulletTime = 0x18FC; // 
                constexpr std::ptrdiff_t m_flNextClientFireBulletTime_Repredict = 0x1900; // 
            ...
            namespace C_PointWorldText {
                ...
                constexpr std::ptrdiff_t m_messageText = 0xD40; // 
                constexpr std::ptrdiff_t m_FontName = 0xF40; // 
                constexpr std::ptrdiff_t m_bEnabled = 0xF80; // 
                constexpr std::ptrdiff_t m_bFullbright = 0xF81; // 
                constexpr std::ptrdiff_t m_flWorldUnitsPerPx = 0xF84; // 
                constexpr std::ptrdiff_t m_flFontSize = 0xF88; // 
                constexpr std::ptrdiff_t m_flDepthOffset = 0xF8C; // 
                constexpr std::ptrdiff_t m_Color = 0xF90; // 
                constexpr std::ptrdiff_t m_nJustifyHorizontal = 0xF94; // 
                constexpr std::ptrdiff_t m_nJustifyVertical = 0xF98; // 
                constexpr std::ptrdiff_t m_nReorientMode = 0xF9C; // 
            }
            // Parent: C_BaseGrenade
            // Field count: 0
            ...
            namespace CCSPlayerController {
                ...
                constexpr std::ptrdiff_t m_vecKills = 0x838; // 
